                ...
                <div class="row mb-9">
                    ...
                    <div class="col-lg-8">
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <div data-userpicLink="{{ asset('assets/user.svg') }}" data-userpic="preview" class="image-input-wrapper w-200px h-200px" style="background-position: center; background-size: 95%;  background-image: url({{  $user->url ? asset('storage/' . $user->url) : asset('assets/user.svg') }})"></div>
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="" data-bs-original-title="Change avatar">
                                ...
                                <input data-userpic="input" type="file" name="url" accept=".png, .jpg, .jpeg">
                            </label>
                            <label data-userpic="clear" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-bs-toggle="tooltip" title="" data-bs-original-title="Set default image" style="position: absolute; right: -11px; bottom: -11px">
                                <i class="fs-7">
                                ...
                                <input data-userpic="delete-flag" name="userpic_delete_flag" type="hidden" value="">
                            </label>
                        </div>
                    </div>
                </div>
